...
authrouter.post('/become-delivery', authtokenmiddleware, authController.becomeDelivery)
authrouter.put('/update-settings', authtokenmiddleware, authController.updateSettings)
